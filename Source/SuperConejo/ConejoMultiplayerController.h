...
#include "ConejoMultiplayerController.generated.h"

/**
 * 
 */
UCLASS()
class SUPERCONEJO_API AConejoMultiplayerController : public APlayerController
{
	GENERATED_BODY()
	
public:
	/* Constructor */
	AConejoMultiplayerController(const FObjectInitializer& ObjectInitializer);
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "SuperConejo")
